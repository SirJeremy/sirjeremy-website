...
export const SocialX = ({className=defaultSocialStyles}) => {
  return (
...
export const SocialGithub = ({className=defaultSocialStyles}) => {
  return (
    <svg className={className} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
...
export const SocialLinkedin = ({className=defaultSocialStyles}) => {
  return (
    <svg className={className} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
...
export const SocialFacebook = ({className=defaultSocialStyles}) => {
  return (
    <svg className={className} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
